  ...
  return (
      <div className={style.continerIK}>
          ...
          <div className={style.infok}>
              <h3><p className={style.p}>kunyomi :</p>{data.kanji.kunyomi.hiragana}<p className={style.p}>onyomi :</p>{data.kanji.onyomi.katakana}</h3>
              <h3><p className={style.p}>meaning :</p>{data.kanji.meaning.english}</h3>
              <h3><p className={style.p}>examples :</p></h3>
              <h3>{data.examples[0].japanese}</h3>
              <audio className={style.audio} src={data.examples[0].audio.mp3} controls  preload="metadata" />
              <h3><p className={style.p}>radcal :</p>{data.radical.character}</h3>
              <h3><p className={style.p}>radical :</p>{data.radical.meaning.english}</h3>
          </div>
            </>
